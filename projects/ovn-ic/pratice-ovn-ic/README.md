...
**Phase 1 — single-VM lab (issue CLO-77):**
...
### Expected results
To obtain a **proof of concept of communication between VMs across distinct Incus clouds**, validating the use of OVN-IC as a federation solution applicable to our infrastructure.
